...
function CTASection() {
  return (
    <section className="py-32 bg-background relative overflow-hidden">
      ...
      >
        <h2 className="text-4xl md:text-5xl font-extrabold mb-6 tracking-tight">Ready to go viral?</h2>
        ...
        <p className="mt-8 text-sm font-medium text-muted-foreground">3 free projects completely on us. No credit card required.</p>
      </motion.div>
    </section>
  );
}
